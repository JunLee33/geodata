...
$(function(){
    ...
    $('#date_time_start').change(function () {
        ...
        $('#date_time_end').datetimepicker({theme:'dark', timepicker:false, format:'Y-m-d', minDate:($('#date_time_start').val())});
    })
    ...
    $('#date_time_end').change(function () {
        ...
        if(moment(startdatetime, 'YYYY-MM-DDTHH:mm:ssZ') > moment(enddatetime, 'YYYY-MM-DDTHH:mm:ssZ')){
            console.log("ininin")
            $('#date_time_end').val('')
        }
    })
    ...
    $.ajax({
        ...
        success:function(data) {
            ...
            for(let i=0; i<project.length; i++){
                ...
                let end_date = moment(project[i].project_ed_dt, 'YYYY-MM-DDTHH:mm:ssZ');
                let today = moment()
