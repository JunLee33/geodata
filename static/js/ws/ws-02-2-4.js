...
$(function(){
    ...
    //     $('#chart').attr("href", "ws-02-2-6?sensor_idx="+sensor_idx+"&sensor_idy="+sensor_idy+"&sensor_namex="+sensor_namex+"&sensor_namey="+sensor_namey+"&project_id="+project_id+"&sensorgroup_type="+sensorgroup_type)
    //     $('#trend').attr("href", "ws-02-2-7?sensor_idx="+sensor_idx+"&sensor_idy="+sensor_idy+"&sensor_namex="+sensor_namex+"&sensor_namey="+sensor_namey+"&project_id="+project_id+"&sensorgroup_type="+sensorgroup_type)
    //     $('#data').attr("href", "ws-02-2-8?sensor_idx="+sensor_idx+"&sensor_idy="+sensor_idy+"&sensor_namex="+sensor_namex+"&sensor_namey="+sensor_namey+"&project_id="+project_id+"&sensorgroup_type="+sensorgroup_type)
    //     $('#fomula').attr("href", "ws-02-2-4?sensor_idx="+sensor_idx+"&sensor_idy="+sensor_idy+"&sensor_namex="+sensor_namex+"&sensor_namey="+sensor_namey+"&project_id="+project_id+"&sensorgroup_type="+sensorgroup_type)
    //     $('#info').attr("href", "ws-02-2-9?sensor_idx="+sensor_idx+"&sensor_idy="+sensor_idy+"&sensor_namex="+sensor_namex+"&sensor_namey="+sensor_namey+"&project_id="+project_id+"&sensorgroup_type="+sensorgroup_type)
    //     sensor_id = sensor_idx
    // }else{
    //     $('#trend').hide()
    //     $('#chart').attr("href", "ws-02-2-1?sensor_id="+sensor_id+"&sensor_name="+sensor_name+"&project_id="+project_id+"&sensorgroup_type="+sensorgroup_type)
    //     $('#data').attr("href", "ws-02-2-3?sensor_id="+sensor_id+"&sensor_name="+sensor_name+"&project_id="+project_id+"&sensorgroup_type="+sensorgroup_type)
    //     $('#fomula').attr("href", "ws-02-2-4?sensor_id="+sensor_id+"&sensor_name="+sensor_name+"&project_id="+project_id+"&sensorgroup_type="+sensorgroup_type)
    //     $('#info').attr("href", "ws-02-2-5?sensor_id="+sensor_id+"&sensor_name="+sensor_name+"&project_id="+project_id+"&sensorgroup_type="+sensorgroup_type)
    // }

    $.ajax({
        url:"sensordetail/select?sensor_id="+sensor_id,
        type:"get",
        contentType: false,
        processData : false,
        async : false,
    ...
    if(delconfirm){
        ...
        $.ajax({
            ...
            error:function(err){
             ...
             success:function(json) {
                 console.log(json.resultString)
                 window.location.href =  "/ws-02-2-4?sensor_id="+sensor_id+"&project_id="+project_id+"&sensorgroup_type="+sensorgroup_type+"&date_time_start="+date_time_start+"&date_time_end="+date_time_end +"&intervalday="+intervalday+"&time="+time
             }
        })
    }
...
function fomulaadd(type){
    ...
    $('#fomulas').empty()
    $('#fomulas').append("<option>변위공식 불러오기</option>")
    ...
    $.ajax({
        ...
        success:function(data) {
            ...
            for(let i = 0; i<fomula_list.length; i++){
                $('#fomulas').append("<option value='"+fomula_list[i].function_formula+"'>"+fomula_list[i].function_name+"</option>")
    ...
    $('#fomulas').change(function(){
        console.log("change")
        let function_id = $('#fomulas option:selected').val()
        console.log(function_id)
