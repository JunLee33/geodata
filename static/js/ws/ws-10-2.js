         ...
         success:function(json) {
            ...
            for(let i =0; i< sensorlist.length; i++){
                ...
                if(sensorlist[i].use_yn == 'Y'){
                    ...
                    if(parseInt(sensorlist[i].sensor_index) % 2 == 0){
                        sensortable +=     "<td id='sensorindex_"+i+"' value='"+sensorlist[i].sensor_display_index+"' style='color: #1e87f0;'>"+sensorlist[i].sensor_index+"</td>"
                    }else{
    ...
    for(let i =0; i < tablelength; i++){
        ...
        if(sensoroption == 'single'){
            if(sensornamelist_single.indexOf(sensordisplayname) != -1 || sensornamelist.indexOf(sensordisplayname) != -1){
                alert("중복된 센서명('"+sensordisplayname+"')을 사용하실 수 없습니다.\n DATA NO. : "+sensor_index)
                return;
            }
...
function addrow(idx){
    ...
    for(let i =0; i< tabledata.length; i++){
        if(tabledata[i].use_yn == 'Y'){
            let sensortable =  " <tr data-state='done'>"
            if(parseInt(tabledata[i].sensor_index) % 2 == 0){
                sensortable +=     "<td id='sensorindex_"+i+"' value='"+sensordisplayindex+"' style='color: #1e87f0;'>"+tabledata[i].sensor_index+"</td>"
            }else{
            ...
            let sensortable =  " <tr data-state='done'>"
            if(parseInt(tabledata[i].sensor_index) % 2 == 0){
                sensortable +=     "<td id='sensorindex_"+i+"' value='0' style='color: #1e87f0;'>"+tabledata[i].sensor_index+"</td>"
            }else{
