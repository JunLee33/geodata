            ...
            if(user_list){
                if(user_list > 0){
                    ...
                    for(i=0; i<user_list.length; i++){
                        if(user_list[i].user_grade == '0103'){
                            $('#ManagementId').val(user_list[i].user_id)
                            $('#ManagementPwd').val(user_list[i].user_pwd)
                            $('#ManagementId').attr('readonly', true)
                        } else if(user_list[i].user_grade == '0104'){
                            $('#MonitoringId').val(user_list[i].user_id)
                            $('#MonitoringPwd').val(user_list[i].user_pwd)
