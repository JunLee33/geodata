...
$(function(){
    ...
    // notice_id = urlParams.get('notice_id')
    ...
    $.ajax({
        ...
        success:function(data) {
            ...
            for(let i = 0; i<notice_list.length; i++){
                ...
                tdtag +=  "<td><a href='/ws-05-1?"+encodeURIComponent("Acd="+notice_list[i].notice_id+"&cHJ="+project_id)+"'>"+notice_list[i].notice_title+"</a></td>"
                tdtag +=  "</tr>"
