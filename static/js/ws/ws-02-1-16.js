...
$(function(){
    ...
    $.ajax({
        ...
        error:function(err){
         ...
         success:function(json) {
            ...
            // 로드셀 공식만 매핑
            $.ajax({
                url : '/function_formula/roadcell?project_id='+project_id+"&sensorgroup_id="+sensorgroup_id,
                type : "get",
                contentType : false,
                processData : false,
                error:function(){
    ...
    $('#formuladsavebtn').click(function (){
        $('#formuladsavebtn').attr('disabled',true);
        console.log("!")
        ...
        if(fomulaname.length == 0){
            alert("공식명을 입력해 주세요.")
            $('#fomulaname').focus()
            $('#formuladsavebtn').attr('disabled',false);
            return;
...
function fomulaedit(id, name, fumula) {
    ...
    $('#formulaeditbtn').click(function(){
        $('#formulaeditbtn').attr('disabled',true);
        ...
        if(fomula_name.length == 0){
            alert("공식명을 입력해 주세요.")
            $('#fomulaname').focus()
            $('#formulaeditbtn').attr('disabled',false);
            return;
