...
class SensorDetailModel(db.Model):
    ...
    sensor_gauge_factor =  db.Column(db.String(45), nullable=True)                    # 센서 담당자에게 알림설정
    ...
    sensor_fx1_id =       db.Column(db.String(45), nullable=True)                                # 센서 가이드라인1 최대값
    sensor_fx2_id =       db.Column(db.String(45), nullable=True)                                # 센서 가이드라인1 최대값
    sensor_fx3_id =       db.Column(db.String(45), nullable=True)                                # 센서 가이드라인1 최대값
    sensor_fx4_id =       db.Column(db.String(45), nullable=True)                                # 센서 가이드라인1 최대값
    sensor_fx5_id =       db.Column(db.String(45), nullable=True)                                # 센서 가이드라인1 최대값

    use_yn =               db.Column(db.String(1), nullable=True, default="Y")                    # 센서 사용여부
    user_id =              db.Column(db.String(50), nullable=False)                                # 센서 등록한 사용자 아이디
