...
class PlaceModel(db.Model):
    ...
    place_index = db.Column(db.Integer, nullable=False)                                  # 설치지점 경도
    use_yn =      db.Column(db.String(1), nullable=False, default="Y")                      # 설치지점 사용여부
    user_id =     db.Column(db.String(50), nullable=False)                                  # 설치지점 등록한 사용자 아이디
