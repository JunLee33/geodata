...
# | notimanager_name     | varchar(45)  | NO   |     |         |                 |
# | notimanager_num      | varchar(45)  | NO   |     |         |                 |
# | notimanager_kakao    | varchar(1)   | NO   |     |         |                 |
# | notimanager_lv1      | varchar(1)   | NO   |     |         |                 |
# | notimanager_lv2      | varchar(1)   | NO   |     |         |                 |
# | notimanager_lv3      | varchar(1)   | NO   |     |         |                 |
# | use_yn               | varchar(1)   | NO   |     |         |                 |
