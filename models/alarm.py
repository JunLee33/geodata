...
# | alarm_detail         | varchar(45)  | NO   |     |         |                 |
# | alarm_status         | varchar(100) | NO   |     |         |                 |
# | alarm_post_request   | varchar(45)  | YES  |     |         |                 |
# | alarm_post_yn        | varchar(1)   | YES  |     | "Y"     |                 |
# | alarm_post_date      | datetime     | YES  |     |         |                 |
# | sensor_id            | integer      | NO   |     |         |                 |
# | datarogger_id        | integer      | NO   |     |         |                 |
# | editdata_id          | integer      | YES  |     |         |                 |
# | sensor_data_date     | datetime     | YES  |     |         |                 |
# | use_yn               | varchar(1)   | NO   |     |         |                 |
...
class AlarmModel(db.Model):
    ...
    alarm_detail =          db.Column(db.String(45), nullable=False)                                
    alarm_status =          db.Column(db.String(100), nullable=False)                               
    ...
    datarogger_id =         db.Column(db.Integer, nullable=False)                                
    editdata_id =           db.Column(db.Integer, nullable=False)                                
