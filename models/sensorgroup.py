...
# | sensorgroup_index           | integer      | NO   |     |         |                |
# | sensorgroup_gl1_max         | varchar(10)  |      |     |         |                |
# | sensorgroup_gl1_min         | varchar(10)  |      |     |         |                |
# | sensorgroup_gl2_max         | varchar(10)  |      |     |         |                |
# | sensorgroup_gl2_min         | varchar(10)  |      |     |         |                |
# | sensorgroup_gl3_max         | varchar(10)  |      |     |         |                |
# | sensorgroup_gl3_min         | varchar(10)  |      |     |         |                |
# | sensorgroup_initial_date    | datetime     |      |     |         |                |
# | sensorgroup_interval        | varchar(45)  |      |     |         |                |
# | sensorgroup_fx              | varchar(45)  |      |     |         |                |
# | sensorgroup_gauge_factor    | varchar(45)  |      |     |         |                |
# | use_yn                      | varchar(1)   | NO   |     | "Y"     |                |
# | user_id                     | varchar(50)  | NO   |     |         |                |
# | place_id                    | integer      | NO   |     |         | tbl_place      |
# | project_id                  | integer      | NO   |     |         | tbl_place      |
...
class SensorgroupModel(db.Model):
    ...
    sensorgroup_gl1_max =       db.Column(db.String(10), nullable=True)                                   # 센서그룹 인덱스
    sensorgroup_gl1_min =       db.Column(db.String(10), nullable=True)                                   # 센서그룹 인덱스
    sensorgroup_gl2_max =       db.Column(db.String(10), nullable=True)                                   # 센서그룹 인덱스
    sensorgroup_gl2_min =       db.Column(db.String(10), nullable=True)                                   # 센서그룹 인덱스
    sensorgroup_gl3_max =       db.Column(db.String(10), nullable=True)                                   # 센서그룹 인덱스
    sensorgroup_gl3_min =       db.Column(db.String(10), nullable=True)                                   # 센서그룹 인덱스
    sensorgroup_initial_date =  db.Column(db.DateTime, nullable=True)                                   # 센서그룹 인덱스
    sensorgroup_interval =      db.Column(db.String(45), nullable=True)                                   # 센서그룹 인덱스
    sensorgroup_fx =            db.Column(db.String(45), nullable=True)                                   # 센서그룹 인덱스
    sensorgroup_gauge_factor =  db.Column(db.String(45), nullable=True)                                   # 센서그룹 인덱스
    use_yn =                    db.Column(db.String(1), nullable=False, default="Y")                      # 센서그룹 사용여부
    user_id =                   db.Column(db.String(50), nullable=False)                                  # 센서그룹 등록한 사용자 아이디
