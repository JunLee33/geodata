...
class UserModel(db.Model):
    ...
    user_nm =       db.Column(db.String(200), nullable=False)                                  # 사용자명
    ...
    def find_by_project_id(cls, project_id):
        sql = """select user_id, user_pwd, user_grade from tbl_user where project_id = '"""+project_id+"""' 
                order by user_grade;"""
