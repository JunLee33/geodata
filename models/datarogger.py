...
# | datarogger_name      | varchar(100) | NO   |     |         |                |
# | datarogger_url       | varchar(200) | NO   |     |         |                |
# | datarogger_request   | varchar(45)  |      |     |         |                |
# | use_yn               | varchar(1)   | NO   |     | "Y"     |                |
# | user_id              | varchar(50)  | YES  |     | NULL    |                |
# | company_id           | integer      | YES  |     | NULL    | tbl_place      |
...
class DataroggerModel(db.Model):
    ...
    datarogger_request =    db.Column(db.String(45), nullable=False)                                  
    ...
    company_id =            db.Column(db.Integer, nullable=True, default=None)                        # 데이터로거가 포함된 컴퍼니 아이디
