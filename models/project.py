...
# | project_lat          | varchar(20)  |      |     |         |                |
# | project_lng          | varchar(20)  |      |     |         |                |
# | project_img          | varchar(200) |      |     |         |                |
# | project_fp_img       | varchar(200) |      |     |         |                |
# | project_weather_nx   | varchar(10)  |      |     |         |                |
# | project_weather_ny   | varchar(10)  |      |     |         |                |
...
class ProjectModel(db.Model):
    ...
    project_lat =           db.Column(db.String(20), nullable=True)                                    # 프로젝트 위도
    project_lng =           db.Column(db.String(20), nullable=True)                                    # 프로젝트 경도
