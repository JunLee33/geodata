...
class FunctionFormula(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            function_obj = FunctionModel(function_name, function_formula, fomula_status, 'Y',  user_id, project_id, company_id, None, create_date, modify_date)
...
class Formularoadcell(Resource):
    ...
    def get(self):
        project_id =              request.args.get('project_id')
        sensorgroup_id =          request.args.get('sensorgroup_id')
        print("project_id", project_id, sensorgroup_id)
    
        data = [dict(r) for r in FunctionModel.find_by_roadcell(project_id, sensorgroup_id)]
    ...
    def post(self):
        ...
        try:
            ...
            function_obj = FunctionModel(function_name, function_formula, '0204', 'Y',  user_id, project_id, company_id, sensorgroup_id, create_date, modify_date)
            function_obj.save_to_db()
...
class FunctionFormulaCompany(Resource):
    ...
    def post(self):
        ...
        try:
            ...
            # 0000 성진지오텍 0001 고객사 0002 프로젝트 0205 로드셀
            project_id = '0'
            function_obj = FunctionModel(function_name, function_formula, '0001', 'Y',  user_id, project_id, company_id, None, create_date, modify_date)
            function_obj.save_to_db()
